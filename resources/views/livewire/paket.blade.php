@section('titless', 'Packlese - Paketin Yuk!')
<main id="main">
  <!-- ======= Single Blog Section ======= -->
        ...
        <div class="col-12">
          <div class="row justify-content-center">
            <div class="col-md-10 text-center hero-text">
              <h1 data-aos="fade-up" data-aos-delay="">Paketin Yuk!</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 blog-content">
          <div class="mt-3 mb-3">
            <h4>Layanan Paketin Barang</h4>
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-indicators">
                @foreach ($paket as $key => $photo)
            ...
            <div class="card border-0">
              <div class="card-body">
                <ul class="comment-list">
                  @if(count($paketPaginate) != 0)
                  @foreach($paketPaginate as $comment)
...
<!-- Modal -->
<div id="updaterating_paket" class="modal" tabindex="-1">
