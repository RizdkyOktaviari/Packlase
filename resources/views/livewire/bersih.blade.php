@section('titless', 'Packlese - Bersihin Yuk!')
<main id="main">
  <!-- ======= Single Blog Section ======= -->
        ...
        <div class="col-12">
          <div class="row justify-content-center">
            <div class="col-md-10 text-center hero-text">
              <h1 data-aos="fade-up" data-aos-delay="">Bersihin Yuk!</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 blog-content">
          <div class="mt-3 mb-3">
            <h4>Layanan Bersih - Bersih Ruangan</h4>
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-indicators">
                @foreach ($bersih as $key => $photo)
            ...
            <div class="card border-0">
              <div class="card-body">
                <ul class="comment-list">
                  @if(count($bersihPaginate) != 0)
                  @foreach($bersihPaginate as $comment)
...
<!-- Modal -->
<div id="updaterating_bersih" class="modal" tabindex="-1">
